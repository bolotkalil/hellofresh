...
class RecipeRatedTest extends TestCase
{
    use Helper;
    private $container;
    ...
    public function testRated()
    {
        ...
        $response = $this->serialize(new \app\Entity\Recipes\Response\RecipeRated(
            1,
            1,
            5
        ), $request,
        ...
        $this->assertEquals(
            '{"rate_id":1,"recipe_id":1,"rate":5,"_links":{"self":{"href":"\/recipes\/1\/rating"}}}',
